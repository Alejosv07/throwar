...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:di,depthTest:!1,depthWrite:!1})}function Ux(r,t,e){const n=new Float32Array(es),i=new H(0,1,0);return new xi({name:"SphericalGaussianBlur",defines:{n:es,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Go(),fragmentShader:`
...
`)+`
`+p);const y=g+m+o,S=g+p+a,E=bh(i,i.VERTEX_SHADER,y),b=bh(i,i.FRAGMENT_SHADER,S);i.attachShader(x,E),i.attachShader(x,b),e.index0AttributeName!==void 0?i.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(x,0,"position"),i.linkProgram(x);function A(P){if(r.debug.checkShaderErrors){const F=i.getProgramInfoLog(x)||"",D=i.getShaderInfoLog(E)||"",N=i.getShaderInfoLog(b)||"",U=F.trim(),I=D.trim(),W=N.trim();let z=!0,j=!0;if(i.getProgramParameter(x,i.LINK_STATUS)===!1)if(z=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,x,E,b);else{const Z=Sh(i,E,"vertex"),lt=Sh(i,b,"fragment");ye("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(x,i.VALIDATE_STATUS)+`
...
Program Info Log: `+U+`
`+Z+`
`+lt)}else U!==""?Nt("WebGLProgram: Program Info Log:",U):(I===""||W==="")&&(j=!1);j&&(P.diagnostics={runnable:z,programLog:U,vertexShader:{log:I,prefix:m},fragmentShader:{log:W,prefix:p}})}i.deleteShader(E),i.deleteShader(b),R=new Mo(i,x),v=G_(i,x)}let R;this.getUniforms=function(){return R===void 0&&A(this),R};let v;this.getAttributes=function(){return v===void 0&&A(this),v};let M=e.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return M===!1&&(M=i.getProgramParameter(x,I_)),M},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(x),this.program=void 0},this.type=e.shaderType,this.name=e.shaderName,this.id=N_++,this.cacheKey=t,this.usedTimes=1,this.program=x,this.vertexShader=E,this.fragmentShader=b,this}let tg=0;class eg{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){const e=t.vertexShader,n=t.fragmentShader,i=this._getShaderStage(e),s=this._getShaderStage(n),o=this._getShaderCacheForMaterial(t);return o.has(i)===!1&&(o.add(i),i.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(t){const e=this.materialCache.get(t);for(const n of e)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){const e=this.materialCache;let n=e.get(t);return n===void 0&&(n=new Set,e.set(t,n)),n}_getShaderStage(t){const e=this.shaderCache;let n=e.get(t);return n===void 0&&(n=new ng(t),e.set(t,n)),n}}class ng{constructor(t){this.id=tg++,this.code=t,this.usedTimes=0}}function ig(r,t,e,n,i,s,o){const a=new ic,l=new eg,c=new Set,h=[],d=i.logarithmicDepthBuffer,u=i.vertexTextures;let f=i.precision;const _={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function x(v){return c.add(v),v===0?"uv":`uv${v}`}function m(v,M,P,F,D){const N=F.fog,U=D.geometry,I=v.isMeshStandardMaterial?F.environment:null,W=(v.isMeshStandardMaterial?e:t).get(v.envMap||I),z=W&&W.mapping===Bo?W.image.height:null,j=_[v.type];v.precision!==null&&(f=i.getMaxPrecision(v.precision),f!==v.precision&&Nt("WebGLProgram.getParameters:",v.precision,"not supported, using",f,"instead."));const Z=U.morphAttributes.position||U.morphAttributes.normal||U.morphAttributes.color,lt=Z!==void 0?Z.length:0;let et=0;U.morphAttributes.position!==void 0&&(et=1),U.morphAttributes.normal!==void 0&&(et=2),U.morphAttributes.color!==void 0&&(et=3);let Pt,Ut,Gt,K;if(j){const Qt=kn[j];Pt=Qt.vertexShader,Ut=Qt.fragmentShader}else Pt=v.vertexShader,Ut=v.fragmentShader,l.update(v),Gt=l.getVertexShaderID(v),K=l.getFragmentShaderID(v);const Q=r.getRenderTarget(),_t=r.state.buffers.depth.getReversed(),Bt=D.isInstancedMesh===!0,St=D.isBatchedMesh===!0,Xt=!!v.map,Ue=!!v.matcap,Wt=!!W,he=!!v.aoMap,O=!!v.lightMap,qt=!!v.bumpMap,Yt=!!v.normalMap,ae=!!v.displacementMap,yt=!!v.emissiveMap,de=!!v.metalnessMap,Tt=!!v.roughnessMap,Ot=v.anisotropy>0,L=v.clearcoat>0,T=v.dispersion>0,G=v.iridescence>0,$=v.sheen>0,tt=v.transmission>0,Y=Ot&&!!v.anisotropyMap,Mt=L&&!!v.clearcoatMap,ht=L&&!!v.clearcoatNormalMap,wt=L&&!!v.clearcoatRoughnessMap,bt=G&&!!v.iridescenceMap,nt=G&&!!v.iridescenceThicknessMap,rt=$&&!!v.sheenColorMap,Dt=$&&!!v.sheenRoughnessMap,Ct=!!v.specularMap,ft=!!v.specularColorMap,It=!!v.specularIntensityMap,B=tt&&!!v.transmissionMap,ut=tt&&!!v.thicknessMap,ot=!!v.gradientMap,at=!!v.alphaMap,it=v.alphaTest>0,J=!!v.alphaHash,gt=!!v.extensions;let Ft=Ni;v.toneMapped&&(Q===null||Q.isXRRenderTarget===!0)&&(Ft=r.toneMapping);const le={shaderID:j,shaderType:v.type,shaderName:v.name,vertexShader:Pt,fragmentShader:Ut,defines:v.defines,customVertexShaderID:Gt,customFragmentShaderID:K,isRawShaderMaterial:v.isRawShaderMaterial===!0,glslVersion:v.glslVersion,precision:f,batching:St,batchingColor:St&&D._colorsTexture!==null,instancing:Bt,instancingColor:Bt&&D.instanceColor!==null,instancingMorph:Bt&&D.morphTexture!==null,supportsVertexTextures:u,outputColorSpace:Q===null?r.outputColorSpace:Q.isXRRenderTarget===!0?Q.texture.colorSpace:cs,alphaToCoverage:!!v.alphaToCoverage,map:Xt,matcap:Ue,envMap:Wt,envMapMode:Wt&&W.mapping,envMapCubeUVHeight:z,aoMap:he,lightMap:O,bumpMap:qt,normalMap:Yt,displacementMap:u&&ae,emissiveMap:yt,normalMapObjectSpace:Yt&&v.normalMapType===Vf,normalMapTangentSpace:Yt&&v.normalMapType===kf,metalnessMap:de,roughnessMap:Tt,anisotropy:Ot,anisotropyMap:Y,clearcoat:L,clearcoatMap:Mt,clearcoatNormalMap:ht,clearcoatRoughnessMap:wt,dispersion:T,iridescence:G,iridescenceMap:bt,iridescenceThicknessMap:nt,sheen:$,sheenColorMap:rt,sheenRoughnessMap:Dt,specularMap:Ct,specularColorMap:ft,specularIntensityMap:It,transmission:tt,transmissionMap:B,thicknessMap:ut,gradientMap:ot,opaque:v.transparent===!1&&v.blending===Os&&v.alphaToCoverage===!1,alphaMap:at,alphaTest:it,alphaHash:J,combine:v.combine,mapUv:Xt&&x(v.map.channel),aoMapUv:he&&x(v.aoMap.channel),lightMapUv:O&&x(v.lightMap.channel),bumpMapUv:qt&&x(v.bumpMap.channel),normalMapUv:Yt&&x(v.normalMap.channel),displacementMapUv:ae&&x(v.displacementMap.channel),emissiveMapUv:yt&&x(v.emissiveMap.channel),metalnessMapUv:de&&x(v.metalnessMap.channel),roughnessMapUv:Tt&&x(v.roughnessMap.channel),anisotropyMapUv:Y&&x(v.anisotropyMap.channel),clearcoatMapUv:Mt&&x(v.clearcoatMap.channel),clearcoatNormalMapUv:ht&&x(v.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:wt&&x(v.clearcoatRoughnessMap.channel),iridescenceMapUv:bt&&x(v.iridescenceMap.channel),iridescenceThicknessMapUv:nt&&x(v.iridescenceThicknessMap.channel),sheenColorMapUv:rt&&x(v.sheenColorMap.channel),sheenRoughnessMapUv:Dt&&x(v.sheenRoughnessMap.channel),specularMapUv:Ct&&x(v.specularMap.channel),specularColorMapUv:ft&&x(v.specularColorMap.channel),specularIntensityMapUv:It&&x(v.specularIntensityMap.channel),transmissionMapUv:B&&x(v.transmissionMap.channel),thicknessMapUv:ut&&x(v.thicknessMap.channel),alphaMapUv:at&&x(v.alphaMap.channel),vertexTangents:!!U.attributes.tangent&&(Yt||Ot),vertexColors:v.vertexColors,vertexAlphas:v.vertexColors===!0&&!!U.attributes.color&&U.attributes.color.itemSize===4,pointsUvs:D.isPoints===!0&&!!U.attributes.uv&&(Xt||at),fog:!!N,useFog:v.fog===!0,fogExp2:!!N&&N.isFogExp2,flatShading:v.flatShading===!0&&v.wireframe===!1,sizeAttenuation:v.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:_t,skinning:D.isSkinnedMesh===!0,morphTargets:U.morphAttributes.position!==void 0,morphNormals:U.morphAttributes.normal!==void 0,morphColors:U.morphAttributes.color!==void 0,morphTargetsCount:lt,morphTextureStride:et,numDirLights:M.directional.length,numPointLights:M.point.length,numSpotLights:M.spot.length,numSpotLightMaps:M.spotLightMap.length,numRectAreaLights:M.rectArea.length,numHemiLights:M.hemi.length,numDirLightShadows:M.directionalShadowMap.length,numPointLightShadows:M.pointShadowMap.length,numSpotLightShadows:M.spotShadowMap.length,numSpotLightShadowsWithMaps:M.numSpotLightShadowsWithMaps,numLightProbes:M.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:v.dithering,shadowMapEnabled:r.shadowMap.enabled&&P.length>0,shadowMapType:r.shadowMap.type,toneMapping:Ft,decodeVideoTexture:Xt&&v.map.isVideoTexture===!0&&Zt.getTransfer(v.map.colorSpace)===ee,decodeVideoTextureEmissive:yt&&v.emissiveMap.isVideoTexture===!0&&Zt.getTransfer(v.emissiveMap.colorSpace)===ee,premultipliedAlpha:v.premultipliedAlpha,doubleSided:v.side===hi,flipSided:v.side===$e,useDepthPacking:v.depthPacking>=0,depthPacking:v.depthPacking||0,index0AttributeName:v.index0AttributeName,extensionClipCullDistance:gt&&v.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(gt&&v.extensions.multiDraw===!0||St)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:v.customProgramCacheKey()};return le.vertexUv1s=c.has(1),le.vertexUv2s=c.has(2),le.vertexUv3s=c.has(3),c.clear(),le}function p(v){const M=[];if(v.shaderID?M.push(v.shaderID):(M.push(v.customVertexShaderID),M.push(v.customFragmentShaderID)),v.defines!==void 0)for(const P in v.defines)M.push(P),M.push(v.defines[P]);return v.isRawShaderMaterial===!1&&(g(M,v),y(M,v),M.push(r.outputColorSpace)),M.push(v.customProgramCacheKey),M.join()}function g(v,M){v.push(M.precision),v.push(M.outputColorSpace),v.push(M.envMapMode),v.push(M.envMapCubeUVHeight),v.push(M.mapUv),v.push(M.alphaMapUv),v.push(M.lightMapUv),v.push(M.aoMapUv),v.push(M.bumpMapUv),v.push(M.normalMapUv),v.push(M.displacementMapUv),v.push(M.emissiveMapUv),v.push(M.metalnessMapUv),v.push(M.roughnessMapUv),v.push(M.anisotropyMapUv),v.push(M.clearcoatMapUv),v.push(M.clearcoatNormalMapUv),v.push(M.clearcoatRoughnessMapUv),v.push(M.iridescenceMapUv),v.push(M.iridescenceThicknessMapUv),v.push(M.sheenColorMapUv),v.push(M.sheenRoughnessMapUv),v.push(M.specularMapUv),v.push(M.specularColorMapUv),v.push(M.specularIntensityMapUv),v.push(M.transmissionMapUv),v.push(M.thicknessMapUv),v.push(M.combine),v.push(M.fogExp2),v.push(M.sizeAttenuation),v.push(M.morphTargetsCount),v.push(M.morphAttributeCount),v.push(M.numDirLights),v.push(M.numPointLights),v.push(M.numSpotLights),v.push(M.numSpotLightMaps),v.push(M.numHemiLights),v.push(M.numRectAreaLights),v.push(M.numDirLightShadows),v.push(M.numPointLightShadows),v.push(M.numSpotLightShadows),v.push(M.numSpotLightShadowsWithMaps),v.push(M.numLightProbes),v.push(M.shadowMapType),v.push(M.toneMapping),v.push(M.numClippingPlanes),v.push(M.numClipIntersection),v.push(M.depthPacking)}function y(v,M){a.disableAll(),M.supportsVertexTextures&&a.enable(0),M.instancing&&a.enable(1),M.instancingColor&&a.enable(2),M.instancingMorph&&a.enable(3),M.matcap&&a.enable(4),M.envMap&&a.enable(5),M.normalMapObjectSpace&&a.enable(6),M.normalMapTangentSpace&&a.enable(7),M.clearcoat&&a.enable(8),M.iridescence&&a.enable(9),M.alphaTest&&a.enable(10),M.vertexColors&&a.enable(11),M.vertexAlphas&&a.enable(12),M.vertexUv1s&&a.enable(13),M.vertexUv2s&&a.enable(14),M.vertexUv3s&&a.enable(15),M.vertexTangents&&a.enable(16),M.anisotropy&&a.enable(17),M.alphaHash&&a.enable(18),M.batching&&a.enable(19),M.dispersion&&a.enable(20),M.batchingColor&&a.enable(21),M.gradientMap&&a.enable(22),v.push(a.mask),a.disableAll(),M.fog&&a.enable(0),M.useFog&&a.enable(1),M.flatShading&&a.enable(2),M.logarithmicDepthBuffer&&a.enable(3),M.reversedDepthBuffer&&a.enable(4),M.skinning&&a.enable(5),M.morphTargets&&a.enable(6),M.morphNormals&&a.enable(7),M.morphColors&&a.enable(8),M.premultipliedAlpha&&a.enable(9),M.shadowMapEnabled&&a.enable(10),M.doubleSided&&a.enable(11),M.flipSided&&a.enable(12),M.useDepthPacking&&a.enable(13),M.dithering&&a.enable(14),M.transmission&&a.enable(15),M.sheen&&a.enable(16),M.opaque&&a.enable(17),M.pointsUvs&&a.enable(18),M.decodeVideoTexture&&a.enable(19),M.decodeVideoTextureEmissive&&a.enable(20),M.alphaToCoverage&&a.enable(21),v.push(a.mask)}function S(v){const M=_[v.type];let P;if(M){const F=kn[M];P=yp.clone(F.uniforms)}else P=v.uniforms;return P}function E(v,M){let P;for(let F=0,D=h.length;F<D;F++){const N=h[F];if(N.cacheKey===M){P=N,++P.usedTimes;break}}return P===void 0&&(P=new Q_(r,M,v,s),h.push(P)),P}function b(v){if(--v.usedTimes===0){const M=h.indexOf(v);h[M]=h[h.length-1],h.pop(),v.destroy()}}function A(v){l.remove(v)}function R(){l.dispose()}return{getParameters:m,getProgramCacheKey:p,getUniforms:S,acquireProgram:E,releaseProgram:b,releaseShaderCache:A,programs:h,dispose:R}}function sg(){let r=new WeakMap;function t(o){return r.has(o)}function e(o){let a=r.get(o);return a===void 0&&(a={},r.set(o,a)),a}function n(o){r.delete(o)}function i(o,a,l){r.get(o)[a]=l}function s(){r=new WeakMap}return{has:t,get:e,remove:n,update:i,dispose:s}}function rg(r,t){return r.groupOrder!==t.groupOrder?r.groupOrder-t.groupOrder:r.renderOrder!==t.renderOrder?r.renderOrder-t.renderOrder:r.material.id!==t.material.id?r.material.id-t.material.id:r.z!==t.z?r.z-t.z:r.id-t.id}function Ch(r,t){return r.groupOrder!==t.groupOrder?r.groupOrder-t.groupOrder:r.renderOrder!==t.renderOrder?r.renderOrder-t.renderOrder:r.z!==t.z?t.z-r.z:r.id-t.id}function Rh(){const r=[];let t=0;const e=[],n=[],i=[];function s(){t=0,e.length=0,n.length=0,i.length=0}function o(d,u,f,_,x,m){let p=r[t];return p===void 0?(p={id:d.id,object:d,geometry:u,material:f,groupOrder:_,renderOrder:d.renderOrder,z:x,group:m},r[t]=p):(p.id=d.id,p.object=d,p.geometry=u,p.material=f,p.groupOrder=_,p.renderOrder=d.renderOrder,p.z=x,p.group=m),t++,p}function a(d,u,f,_,x,m){const p=o(d,u,f,_,x,m);f.transmission>0?n.push(p):f.transparent===!0?i.push(p):e.push(p)}function l(d,u,f,_,x,m){const p=o(d,u,f,_,x,m);f.transmission>0?n.unshift(p):f.transparent===!0?i.unshift(p):e.unshift(p)}function c(d,u){e.length>1&&e.sort(d||rg),n.length>1&&n.sort(u||Ch),i.length>1&&i.sort(u||Ch)}function h(){for(let d=t,u=r.length;d<u;d++){const f=r[d];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null}}return{opaque:e,transmissive:n,transparent:i,init:s,push:a,unshift:l,finish:h,sort:c}}function og(){let r=new WeakMap;function t(n,i){const s=r.get(n);let o;return s===void 0?(o=new Rh,r.set(n,[o])):i>=s.length?(o=new Rh,s.push(o)):o=s[i],o}function e(){r=new WeakMap}return{get:t,dispose:e}}function ag(){const r={};return{get:function(t){if(r[t.id]!==void 0)return r[t.id];let e;switch(t.type){case"DirectionalLight":e={direction:new H,color:new ie};break;case"SpotLight":e={position:new H,direction:new H,color:new ie,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":e={position:new H,color:new ie,distance:0,decay:0};break;case"HemisphereLight":e={direction:new H,skyColor:new ie,groundColor:new ie};break;case"RectAreaLight":e={color:new ie,position:new H,halfWidth:new H,halfHeight:new H};break}return r[t.id]=e,e}}}function lg(){const r={};return{get:function(t){if(r[t.id]!==void 0)return r[t.id];let e;switch(t.type){case"DirectionalLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Vt};break;case"SpotLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Vt};break;case"PointLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Vt,shadowCameraNear:1,shadowCameraFar:1e3};break}return r[t.id]=e,e}}}let cg=0;function hg(r,t){return(t.castShadow?2:0)-(r.castShadow?2:0)+(t.map?1:0)-(r.map?1:0)}function ug(r){const t=new ag,e=lg(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new H);const i=new H,s=new Ce,o=new Ce;function a(c){let h=0,d=0,u=0;for(let v=0;v<9;v++)n.probe[v].set(0,0,0);let f=0,_=0,x=0,m=0,p=0,g=0,y=0,S=0,E=0,b=0,A=0;c.sort(hg);for(let v=0,M=c.length;v<M;v++){const P=c[v],F=P.color,D=P.intensity,N=P.distance,U=P.shadow&&P.shadow.map?P.shadow.map.texture:null;if(P.isAmbientLight)h+=F.r*D,d+=F.g*D,u+=F.b*D;else if(P.isLightProbe){for(let I=0;I<9;I++)n.probe[I].addScaledVector(P.sh.coefficients[I],D);A++}else if(P.isDirectionalLight){const I=t.get(P);if(I.color.copy(P.color).multiplyScalar(P.intensity),P.castShadow){const W=P.shadow,z=e.get(P);z.shadowIntensity=W.intensity,z.shadowBias=W.bias,z.shadowNormalBias=W.normalBias,z.shadowRadius=W.radius,z.shadowMapSize=W.mapSize,n.directionalShadow[f]=z,n.directionalShadowMap[f]=U,n.directionalShadowMatrix[f]=P.shadow.matrix,g++}n.directional[f]=I,f++}else if(P.isSpotLight){const I=t.get(P);I.position.setFromMatrixPosition(P.matrixWorld),I.color.copy(F).multiplyScalar(D),I.distance=N,I.coneCos=Math.cos(P.angle),I.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),I.decay=P.decay,n.spot[x]=I;const W=P.shadow;if(P.map&&(n.spotLightMap[E]=P.map,E++,W.updateMatrices(P),P.castShadow&&b++),n.spotLightMatrix[x]=W.matrix,P.castShadow){const z=e.get(P);z.shadowIntensity=W.intensity,z.shadowBias=W.bias,z.shadowNormalBias=W.normalBias,z.shadowRadius=W.radius,z.shadowMapSize=W.mapSize,n.spotShadow[x]=z,n.spotShadowMap[x]=U,S++}x++}else if(P.isRectAreaLight){const I=t.get(P);I.color.copy(F).multiplyScalar(D),I.halfWidth.set(P.width*.5,0,0),I.halfHeight.set(0,P.height*.5,0),n.rectArea[m]=I,m++}else if(P.isPointLight){const I=t.get(P);if(I.color.copy(P.color).multiplyScalar(P.intensity),I.distance=P.distance,I.decay=P.decay,P.castShadow){const W=P.shadow,z=e.get(P);z.shadowIntensity=W.intensity,z.shadowBias=W.bias,z.shadowNormalBias=W.normalBias,z.shadowRadius=W.radius,z.shadowMapSize=W.mapSize,z.shadowCameraNear=W.camera.near,z.shadowCameraFar=W.camera.far,n.pointShadow[_]=z,n.pointShadowMap[_]=U,n.pointShadowMatrix[_]=P.shadow.matrix,y++}n.point[_]=I,_++}else if(P.isHemisphereLight){const I=t.get(P);I.skyColor.copy(P.color).multiplyScalar(D),I.groundColor.copy(P.groundColor).multiplyScalar(D),n.hemi[p]=I,p++}}m>0&&(r.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=ct.LTC_FLOAT_1,n.rectAreaLTC2=ct.LTC_FLOAT_2):(n.rectAreaLTC1=ct.LTC_HALF_1,n.rectAreaLTC2=ct.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=d,n.ambient[2]=u;const R=n.hash;(R.directionalLength!==f||R.pointLength!==_||R.spotLength!==x||R.rectAreaLength!==m||R.hemiLength!==p||R.numDirectionalShadows!==g||R.numPointShadows!==y||R.numSpotShadows!==S||R.numSpotMaps!==E||R.numLightProbes!==A)&&(n.directional.length=f,n.spot.length=x,n.rectArea.length=m,n.point.length=_,n.hemi.length=p,n.directionalShadow.length=g,n.directionalShadowMap.length=g,n.pointShadow.length=y,n.pointShadowMap.length=y,n.spotShadow.length=S,n.spotShadowMap.length=S,n.directionalShadowMatrix.length=g,n.pointShadowMatrix.length=y,n.spotLightMatrix.length=S+E-b,n.spotLightMap.length=E,n.numSpotLightShadowsWithMaps=b,n.numLightProbes=A,R.directionalLength=f,R.pointLength=_,R.spotLength=x,R.rectAreaLength=m,R.hemiLength=p,R.numDirectionalShadows=g,R.numPointShadows=y,R.numSpotShadows=S,R.numSpotMaps=E,R.numLightProbes=A,n.version=cg++)}function l(c,h){let d=0,u=0,f=0,_=0,x=0;const m=h.matrixWorldInverse;for(let p=0,g=c.length;p<g;p++){const y=c[p];if(y.isDirectionalLight){const S=n.directional[d];S.direction.setFromMatrixPosition(y.matrixWorld),i.setFromMatrixPosition(y.target.matrixWorld),S.direction.sub(i),S.direction.transformDirection(m),d++}else if(y.isSpotLight){const S=n.spot[f];S.position.setFromMatrixPosition(y.matrixWorld),S.position.applyMatrix4(m),S.direction.setFromMatrixPosition(y.matrixWorld),i.setFromMatrixPosition(y.target.matrixWorld),S.direction.sub(i),S.direction.transformDirection(m),f++}else if(y.isRectAreaLight){const S=n.rectArea[_];S.position.setFromMatrixPosition(y.matrixWorld),S.position.applyMatrix4(m),o.identity(),s.copy(y.matrixWorld),s.premultiply(m),o.extractRotation(s),S.halfWidth.set(y.width*.5,0,0),S.halfHeight.set(0,y.height*.5,0),S.halfWidth.applyMatrix4(o),S.halfHeight.applyMatrix4(o),_++}else if(y.isPointLight){const S=n.point[u];S.position.setFromMatrixPosition(y.matrixWorld),S.position.applyMatrix4(m),u++}else if(y.isHemisphereLight){const S=n.hemi[x];S.direction.setFromMatrixPosition(y.matrixWorld),S.direction.transformDirection(m),x++}}}return{setup:a,setupView:l,state:n}}function Ph(r){const t=new ug(r),e=[],n=[];function i(h){c.camera=h,e.length=0,n.length=0}function s(h){e.push(h)}function o(h){n.push(h)}function a(){t.setup(e)}function l(h){t.setupView(e,h)}const c={lightsArray:e,shadowsArray:n,camera:null,lights:t,transmissionRenderTarget:{}};return{init:i,state:c,setupLights:a,setupLightsView:l,pushLight:s,pushShadow:o}}function dg(r){let t=new WeakMap;function e(i,s=0){const o=t.get(i);let a;return o===void 0?(a=new Ph(r),t.set(i,[a])):s>=o.length?(a=new Ph(r),o.push(a)):a=o[s],a}function n(){t=new WeakMap}return{get:e,dispose:n}}const fg=`void main() {
	gl_Position = vec4( position, 1.0 );
...
<button type="button" class="btn--play--again" id="playAgain">Play again</button>         
                ...
                `}addGameResult(){this.document&&this.document.querySelector(".main").insertAdjacentHTML("beforeend",this.generateResultHTML())}addGamePoint(){this.document&&this.document.querySelector(".main").insertAdjacentHTML("beforeend",this.generateGamePointHTML())}updatePoint(t){for(const e of this.document.querySelectorAll(".pointScore"))e.textContent=t}updateLife(t){this.document.querySelector(".lifeScore").textContent=t}addGameMenuInit(){this.document&&this.document.querySelector(".main").insertAdjacentHTML("beforeend",this.generateGameMenuInitHTML())}removeGamePoint(){const t=this.document.querySelector(".point");t&&(t.classList.add("is-hidden"),setTimeout(()=>{t.parentElement&&t.parentElement.removeChild(t)},500))}removeGameMenuInit(){const t=this.document.querySelector(".game");t&&(t.classList.add("is-hidden"),setTimeout(()=>{t.parentElement&&t.parentElement.removeChild(t)},500))}removeGameResult(){const t=this.document.querySelector(".result");t&&(t.classList.add("is-hidden"),setTimeout(()=>{t.parentElement&&t.parentElement.removeChild(t)},500))}addEventListenerButtonPlay(t){this.document&&this.document.querySelector(".game__box__startButton").addEventListener("click",()=>{this.removeGameMenuInit(),t()})}addEventListenerButtonPlayAgain(t){this.document&&this.document.querySelector("#playAgain").addEventListener("click",()=>{this.removeGameResult(),t()})}}class WM{constructor(){const t=new ed;t.iterations=15,this.world=new eb({gravity:new w(0,-9.82,0),solver:t}),this.world.allowSleep=!0,this.boxGeometry=new Wo(new w(.5,.5,.5))}createBallBody(t=1,e=20){const n=new pt({mass:e,shape:new Ov(t),type:pt.KINEMATIC});return n.addEventListener("collide",i=>{i.body}),n.position.set(0,t,0),n}creareFloor(){const t=new Bv,e=new pt({mass:0,shape:t});return e.quaternion.setFromAxisAngle(new w(1,0,0),-Math.PI/2),e.position.set(0,0,0),this.world.addBody(e),e}addWorld(t){this.world.addBody(t)}createCube(){return new pt({mass:1,shape:this.boxGeometry,allowSleep:!0,sleepSpeedLimit:.1,sleepTimeLimit:.3})}createCubes(t=1,e=10){let n=[],i=new Float32Array(t*3),s=-5,o=0,a=0;for(let l=0;l<t;l++){let c=this.createCube();l===t/e+o&&(o=l,s+=1),i[a]=s,i[a+1]=.5+(l-o),i[a+2]=10,a+=3,c.position.set(s,.5+(l-o),10),n.push(c),this.addWorld(c)}return{cubes:n,posInitial:i}}}class XM{constructor(){this.geometry=new Js,this.material=new ko({color:"white",wireframe:!1})}createCube(){return new Yn(this.geometry,this.material)}createCubes(t=1){let e=[];for(let n=0;n<t;n++)e.push(this.createCube());return e}}class qM{constructor(t){this.textureLoader=new Vu}loadTexture(t="img/logo.jpeg",e){return new Promise((n,i)=>{this.textureLoader.load(t,s=>{e.map=s,n({ok:"Texture loaded"})},()=>{},s=>{console.error(s),i({error:s})})})}}((r,t)=>{const e=new GM(r),n=new HM(r),i=new WM,s=new Ng;s.mesh.position.set(1.7,6.6,-13);const o=new XM,a=new qM(new Vu);let l=[],c=[],h;const d=i.createBallBody();d.position.copy(s.mesh.position),i.creareFloor();const u={remainingAttempts:3,isBallInPlay:!1,cubesHitThisAttempt:new Set},f=new Lg({width:t.innerWidth,height:t.innerHeight,canvas:r.querySelector("canvas.webgl"),loading:e,gameMenu:n});new Ig(f).activateResizer();const x=new VM(f.camera,f.render.domElement),m=new Vp,p=new Vt;let g=!1,y=0;const S=b=>{if(u.remainingAttempts<=0||u.isBallInPlay){g=!1;return}const A=b.clientX||b.changedTouches&&b.changedTouches[0].clientX,R=b.clientY||b.changedTouches&&b.changedTouches[0].clientY;p.x=A/t.innerWidth*2-1,p.y=-(R/t.innerHeight)*2+1,m.setFromCamera(p,f.camera);const v=m.ray.direction.clone(),P=performance.now()-y,D=20+80*Math.min(P/1e3,1);d.type=pt.DYNAMIC,d.wakeUp(),u.isBallInPlay=!0,d.velocity.set(v.x*D,v.y*D,v.z*D),g=!1},E=()=>{g=!1;let b=100;a.loadTexture("img/logo.jpeg",s.mesh.material).then(()=>{f.scene.add(s.mesh)}),x.control.enabled=!1;const A=i.createCubes(b,10);h.arrayPositionCubes=A.posInitial,l.push(...A.cubes),c.push(...o.createCubes(b));for(const v of c)a.loadTexture("img/logo.jpeg",v.material).then(()=>{f.scene.add(v)});Oo.to(f.camera.position,{x:1.7,y:14,z:-15.5,duration:2,ease:"power2.inOut"}),i.addWorld(d),n.addGamePoint();const R=f.render.domElement;R.addEventListener("mousedown",()=>{u.isBallInPlay||(g=!0,y=performance.now())}),R.addEventListener("mouseup",v=>{g&&S(v)}),R.addEventListener("touchstart",v=>{u.isBallInPlay||(g=!0,y=performance.now())},{passive:!1}),R.addEventListener("touchend",v=>{g&&S(v)},{passive:!1})};f.envMap().then(()=>{n.addEventListenerButtonPlay(E),h=new wM(f.render,f.scene,f.camera,x,i,s,d,l,c,u,n),f.render.setAnimationLoop(h.bucleTick)})})(document,window);
